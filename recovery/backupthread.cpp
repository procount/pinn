...
QByteArray BackupThread::getLabel(const QString part)
{
    QByteArray result;
    QProcess p;
...
QByteArray BackupThread::getUUID(const QString part)
{
    QByteArray result;
    QProcess p;
...
QString BackupThread::getDescription(const QString &folder, const QString &flavour)
{
